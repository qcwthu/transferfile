...
do
        ...
        do
                ...
                do
			python -m torch.distributed.launch --nproc_per_node 1 --master_port 29255 cli_multitask_ddp_prompt_tune1.py \
        		--output_dir models/upstream-multitask-cls2cls-$onelr-$onebs-$oneepoch-64shot  \
