...
do
        ...
        do
                ...
                do
			python -m torch.distributed.launch --nproc_per_node 1 --master_port 29540 cli_multitask_ddp_prompt_tune2.py \
			...
			ps aux | grep cli_multitask_ddp_prompt_tune2.py | awk '{print $2}' |xargs kill -9
		done
	done
done
