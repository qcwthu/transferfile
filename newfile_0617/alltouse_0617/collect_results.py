...
def main():
    ...
    parser.add_argument("--logs_dir", default="../models/T5-large", type=str, required=False)
    parser.add_argument("--output_file", default="../allres/res-pt.csv", type=str, required=False)
