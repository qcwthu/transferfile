...
do
        ...
        do
				...
				do
 		 		...
 		 		python -m torch.distributed.launch --nproc_per_node 2 --master_port 29699 singletask_from_meta_2.py \
        			--task_dir data/${TASK}/ \
        			--task_name ${TASK} \
				...
				--learning_rate_list 5e-1 2e-1 \
        			...
        			--prompt_number 100
      				echo "++++++++++++++++++++++++++++++"
      				ps aux | grep singletask_from_meta_2.py | awk '{print $2}' | xargs kill -9
				done
			 done
                done
        done
