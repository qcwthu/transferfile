	...
	do
		...
		do
            ...
            python cli_maml_ddp_prompt_tune1.py \
              --output_dir models/upstream-maml-cls2cls-$onelr-$oneg-$onestep-$outerlr-12uptasks \
              --custom_tasks_splits ./dataloader/custom_tasks_splits/train_classification_test_classification_12uptasks.json \
              --do_train \
              --prompt_number 100 \
              --cuda 0 \
              --inner_bsz 2 \
