...
do
        ...
        do
                ...
                do
                        ...
                        do
				CHECKPOINT="models/upstream-50prompt-maml-cls2cls-"$onelr"-"$oneg"-"$onestep"-"$outerlr"/last-model.pt"
				IDENTIFIER="T5-"$size"-maml-cls2cls-"$onelr"-"$oneg"-"$onestep"-"$outerlr"-50prompt"
				for TASK in ${TASKS[@]}
				do
