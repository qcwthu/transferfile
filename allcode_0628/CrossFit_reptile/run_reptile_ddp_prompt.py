        ...
        for batch in tqdm(train_data.dataloader, desc="Epoch {}".format(epoch)):
            ...
            with higher.innerloop_ctx(
                ...
                for aa in range(args.reptile_step):
                    ...
                    train_loss = fnet(input_ids=batch[0][aa * args.inner_bsz:(aa + 1) * args.inner_bsz, :], 
                                      attention_mask=batch[1][aa * args.inner_bsz:(aa + 1) * args.inner_bsz, :],
            ...
            if global_batch % args.gradient_accumulation_steps == 0:
                ...
                #             curr_em,
                #             epoch))
                    logger.info("global step: {}; train loss: {}; dev loss".format(global_step, np.mean(train_losses)))
