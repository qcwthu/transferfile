...
do
        ...
        do
			...
			do
  				...
  				python -m torch.distributed.launch --nproc_per_node 2 --master_port 26655 singletask_from_multi_2.py \
        			--task_dir data/${TASK}/ \
        			--task_name ${TASK} \
        			...
        			--model google/t5-v1_1-$size \
 			        --prompt_number 100
     				echo "++++++++++++++++++++++++++++++"
      			ps aux | grep singletask_from_multi_2.py | awk '{print $2}' | xargs kill -9
			done
		done
        done
done
