...
do
        ...
        do
                ...
                do
                    python -m torch.distributed.launch --nproc_per_node 1 --master_port 29531 cli_multitask_ddp_prompt_nocls2cls.py \
                          --output_dir models/upstream-multitask-nocls2cls-$onelr-$onebs-$oneepoch  \
                    ...
                    ps aux | grep cli_multitask_ddp_prompt_nocls2cls.py | awk '{print $2}' |xargs kill -9
		            done
	      done
done
