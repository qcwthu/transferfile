...
do
        ...
        do
                ...
                do
			python -m torch.distributed.launch --nproc_per_node 1 --master_port 29530 cli_multitask_ddp_prompt_qa2qa.py \
        		--output_dir models/upstream-multitask-qa2qa-$onelr-$onebs-$oneepoch  \
			...
			ps aux | grep cli_multitask_ddp_prompt_qa2qa.py | awk '{print $2}' |xargs kill -9
		done
	done
done
