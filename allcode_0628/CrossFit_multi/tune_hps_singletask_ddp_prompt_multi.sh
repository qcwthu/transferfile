...
#TASKS=("glue-cola" "ethos-sexual_orientation" "ai2_arc" "crawl_domain" "samsum" "blimp-sentential_negation_npi_scope" "quoref" "yelp_polarity" "amazon_polarity" "race-high" "blimp-sentential_negation_npi_licensor_present" "tweet_eval-irony" "break-QDMR" "freebase_qa" "glue-qnli" "hatexplain" "circa")
#TASKS=("yelp_polarity" "tweet_eval-irony" "break-QDMR" "freebase_qa" "glue-qnli" "hatexplain" "circa")
#TASKS=("yelp_polarity")
TASKS=("superglue-cb" "dbpedia_14" "wiki_qa" "emo" "yelp_polarity" "ethos-religion" "financial_phrasebank" "tab_fact" "anli" "ethos-race")

#TASKS=("ethos-disability" "glue-cola" "blimp-sentential_negation_npi_scope" "yelp_polarity" "amazon_polarity" "race-high" "blimp-sentential_negation_npi_licensor_present" "tweet_eval-irony" "break-QDMR" "freebase_qa" "glue-qnli" "hatexplain" "circa")
...
CHECKPOINT="models/upstream-multitask-cls2cls/last-model.pt"
...
do
  ...
  python -m torch.distributed.launch --nproc_per_node 2 --master_port 29545 tune_hps_singletask_ddp_prompt_multi.py \
        --task_dir data/${TASK}/ \
        --task_name ${TASK} \
        ...
        --prompt_number 100
      echo "++++++++++++++++++++++++++++++"
      ps aux | grep tune_hps_singletask_ddp_prompt_multi.py | awk '{print $2}' | xargs kill -9
done
