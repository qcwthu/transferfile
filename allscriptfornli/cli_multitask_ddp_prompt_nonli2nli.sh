...
do
        ...
        do
                ...
                do
                    python -m torch.distributed.launch --nproc_per_node 1 --master_port 29541 cli_multitask_ddp_prompt_nonli2nli.py \
                          --output_dir models/upstream-multitask-nonli2nli-$onelr-$onebs-$oneepoch  \
                    ...
                    ps aux | grep cli_multitask_ddp_prompt_nonli2nli.py | awk '{print $2}' |xargs kill -9
		            done
	      done
done
